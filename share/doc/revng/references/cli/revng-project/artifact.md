...
`revng project artifact` - Produce an artifact.

SYNOPSIS
--------

    revng project artifact ARTIFACT [OPTIONS] [OBJECTS] [-- PIPEBOX ARGS...]
...
```{bash notest}
revng project artifact disassemble 0x401000:Code_x86_64
revng project artifact disassemble Sum
```
