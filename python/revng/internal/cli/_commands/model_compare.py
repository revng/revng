...
def selftest():
    ...
    # Test references
    reference = {"a": "/TypeDefinitions/1-Type", "Types": [{"ID": 1, "b": 3}]}
    assert test_subgraph(
        {"a": "/TypeDefinitions/2-Type", "Types": [{"ID": 1, "b": 5}, {"ID": 2, "b": 3}]}, reference
    )
    assert not test_subgraph(
        {"a": "/TypeDefinitions/2-Type", "Types": [{"ID": 1, "b": 5}, {"ID": 2, "b": 4}]}, reference
    )
