...
class ArtifactGroup(click.Group):
    def __init__(self, *args, **kwargs):
        ...
        self.model_ty: type[Model] = get_singleton(Model)
    ...
    def _build_artifact_command(self, artifact_name: str, pipeline: Pipeline):
        ...
        # Here's the core logic of this module:
        ...
        # For the only container,
        # call the `click.argument` decorator to dynamically
        # add its `objects` argument to the command.
