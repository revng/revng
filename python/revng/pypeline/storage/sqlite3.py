...
from revng.pypeline.storage.storage_provider import ContainerLocation, ProjectMetadata
from revng.pypeline.storage.storage_provider import SavePointsRange, StorageProvider
from revng.pypeline.storage.util import _REVNG_VERSION_PLACEHOLDER
...
class SQlite3StorageProvider(StorageProvider):
    ...
    def has(
        ...
        return [ObjectID.deserialize_any(x[0]) for x in result]
    ...
    def get(
        ...
        return {ObjectID.deserialize_any(x[0]): x[1] for x in result}
