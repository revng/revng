...
from revng.pypeline.storage.storage_provider import ConfigurationId, ContainerLocation
from revng.pypeline.storage.storage_provider import ProjectMetadata, SavepointID, SavePointsRange
