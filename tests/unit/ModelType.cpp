...
BOOST_AUTO_TEST_CASE(PrimitiveTypes) {
  revng_check(PrimitiveDefinition(PrimitiveKind::Void, 0).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Unsigned, 1).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Unsigned, 2).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Unsigned, 4).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Unsigned, 8).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Unsigned, 16).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Signed, 1).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Signed, 2).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Signed, 4).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Signed, 8).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Signed, 16).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Float, 2).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Float, 4).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Float, 8).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Float, 10).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Float, 12).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Float, 16).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Generic, 1).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Generic, 2).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Generic, 4).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Generic, 8).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Generic, 10).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Generic, 12).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Generic, 16).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Number, 1).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Number, 2).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Number, 4).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Number, 8).verify(true));
  revng_check(PrimitiveDefinition(PrimitiveKind::Number, 16).verify(true));
  auto PointerOrNumberKind = PrimitiveKind::PointerOrNumber;
  revng_check(PrimitiveDefinition(PointerOrNumberKind, 1).verify(true));
  revng_check(PrimitiveDefinition(PointerOrNumberKind, 2).verify(true));
  revng_check(PrimitiveDefinition(PointerOrNumberKind, 4).verify(true));
  revng_check(PrimitiveDefinition(PointerOrNumberKind, 8).verify(true));
  revng_check(PrimitiveDefinition(PointerOrNumberKind, 16).verify(true));

  for (uint8_t ByteSize = 0; ByteSize < 20; ++ByteSize) {

    using namespace std::string_literals;

    auto Unsigned = PrimitiveDefinition(PrimitiveKind::Unsigned, ByteSize);
    auto Signed = PrimitiveDefinition(PrimitiveKind::Signed, ByteSize);
    auto Number = PrimitiveDefinition(PrimitiveKind::Number, ByteSize);
    auto PointerOrNumber = PrimitiveDefinition(PointerOrNumberKind, ByteSize);
