...
// RUN: ../%revngpipe import-model-names %S/../0-import-types/Extra.yml %s /dev/stdout | ../%revngcliftopt | FileCheck %s
...
// CHECK:     )>
// CHECK:   ]
// CHECK:   return_value_comment "This function only has a return value comment!"
// CHECK: >
