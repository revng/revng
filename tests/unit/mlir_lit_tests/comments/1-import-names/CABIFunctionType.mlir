...
// RUN: ../%revngpipe import-model-names %S/../0-import-types/CABIFunctionType.yml %s /dev/stdout | ../%revngcliftopt | FileCheck %s
...
// CHECK:   return_value_comment "And this is what return value one is like!"
// CHECK: >
