...
clift.bitcast %i : !int32_t -> !uint32_t
clift.bitcast %i : !int32_t -> !my_uint32
clift.bitcast %i : !int32_t -> !my_enum

%t = clift.undef : !my_uint32
clift.bitcast %t : !my_uint32 -> !int32_t

%e = clift.undef : !my_enum
clift.bitcast %e : !my_enum -> !int32_t

%ip = clift.undef : !int32_t$ptr
clift.bitcast %ip : !int32_t$ptr -> !uint32_t$ptr
clift.bitcast %ip : !int32_t$ptr -> !int32_t$const$ptr

%icp = clift.undef : !int32_t$const$ptr
clift.bitcast %icp : !int32_t$const$ptr -> !int32_t$ptr
