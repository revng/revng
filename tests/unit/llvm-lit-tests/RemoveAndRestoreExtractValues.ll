...
; RUN: %revngopt %s -remove-extractvalues | %revngopt -enable-new-pm=1 -O2 | %revngopt -S -restore-extractvalues -strip-dead-prototypes -o - | diff -u <(grep -v -e '^;' -e '^\s*$' %s) <(grep -v -e '^;' -e '^\s*$' -)
...
declare dso_local %0 @helper_syscall_wrapper(ptr, i32, i64, i64, i32, i64, i64, i64, i64, i64, i32, i64, i32, i32, i64, i32, i32, i32, i32, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64) local_unnamed_addr #0
...
newFuncRoot:
  ...
  %3 = tail call %0 @helper_syscall_wrapper(ptr null, i32 2, i64 4206331, i64 %0, i32 %1, i64 %0, i64 %0, i64 %0, i64 %0, i64 %0, i32 %1, i64 %0, i32 %1, i32 %1, i64 %0, i32 %1, i32 %1, i32 %1, i32 %1, i64 %0, i64 %0, i64 %0, i64 %0, i64 %0, i64 231, i64 %0, i64 %0, i64 %0, i64 %0, i64 %0, i64 %0, i64 %2, i64 %0)
  %4 = extractvalue %0 %3, 2
  %5 = extractvalue %0 %3, 3
  %6 = extractvalue %0 %3, 4
  %7 = extractvalue %0 %3, 5
  %8 = extractvalue %0 %3, 6
  %9 = extractvalue %0 %3, 7
  %10 = extractvalue %0 %3, 8
  %11 = extractvalue %0 %3, 9
  %12 = extractvalue %0 %3, 10
  %13 = extractvalue %0 %3, 23
...
bb._Exit.0xf3234:                                 ; preds = %bb._Exit.0xf3234, %newFuncRoot
  ...
  %14 = tail call %0 @helper_syscall_wrapper(ptr null, i32 2, i64 4206341, i64 %state_0x9018.0, i32 %state_0x9010.0, i64 %0, i64 %0, i64 %state_0x8388.0, i64 %0, i64 %state_0x82d8.0, i32 %state_0x8248.0, i64 %state_0x83a0.0, i32 %state_0x83a8.0, i32 %1, i64 %0, i32 %state_0x9080.0, i32 %state_0x8300.0, i32 %1, i32 %1, i64 %0, i64 %0, i64 %0, i64 %0, i64 %0, i64 60, i64 %0, i64 %0, i64 60, i64 %0, i64 %0, i64 %0, i64 %2, i64 %state_0x8370.0)
  %15 = extractvalue %0 %14, 2
  %16 = extractvalue %0 %14, 3
  %17 = extractvalue %0 %14, 4
  %18 = extractvalue %0 %14, 5
  %19 = extractvalue %0 %14, 6
  %20 = extractvalue %0 %14, 7
  %21 = extractvalue %0 %14, 8
  %22 = extractvalue %0 %14, 9
  %23 = extractvalue %0 %14, 10
  %24 = extractvalue %0 %14, 23
  br label %bb._Exit.0xf3234
}

attributes #0 = { noinline optnone }
attributes #1 = { noinline nounwind optnone willreturn memory(read) }
