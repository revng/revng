...
module attributes {clift.module} {
  ...
  // CHECK: `_REG` attribute ('x4_aarch64') differs from the model value ('x0_aarch64'). See '/raw-argument/1-RawFunctionDefinition/x0_aarch64' of '/function/0x1004:Code_aarch64'

  clift.func @f_1<!f_1>(
    !uint64_t {
      clift.c_attributes = [#clift.c_attribute<"_REG" : "/macro/_REG" [#clift.identifier<"x4_aarch64">]>],
