...
module attributes {clift.module} {
  ...
  // CHECK: `_REG` attribute must have an argument. See '/raw-stack-arguments/1-RawFunctionDefinition' of '/function/0x1004:Code_aarch64'

  clift.func @f_1<!f_1>(
    !uint64_t {
      clift.c_attributes = [#clift.c_attribute<"_REG" : "/macro/_REG">],
