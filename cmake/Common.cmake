...
macro(revng_add_library NAME TYPE EXPORT_NAME)
  ...
  add_custom_command(
    ...
    BYPRODUCTS "${CMAKE_BINARY_DIR}/lib/$<TARGET_FILE_NAME:${NAME}>"
  )
...
macro(revng_add_analyses_library NAME EXPORT_NAME)
  ...
  add_custom_command(
    ...
    BYPRODUCTS "${CMAKE_BINARY_DIR}/lib/revng/analyses/$<TARGET_FILE_NAME:${NAME}>"
  )
...
macro(revng_add_private_executable NAME)
  ...
  add_custom_command(
    ...
    BYPRODUCTS "${CMAKE_BINARY_DIR}/bin/$<TARGET_FILE_NAME:${NAME}>"
  )
