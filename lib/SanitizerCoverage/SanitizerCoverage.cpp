...
using SanitizerCoveragePass = RegisterPass<ModuleSanitizerCoverageLegacyPass>;
static SanitizerCoveragePass X("sanitizer-coverage", "Instrument with llvm Sanitizer Coverage", true, true);
