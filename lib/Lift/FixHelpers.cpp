...
static Logger<> Log("helpers-module-fixer");
...
// TODO: this could be done at build time. We need a portion of the feature of
//       VariableManager. Specifically, we need:
//       getByCPUStateOffsetWithRemainder, storeToCPUStateOffset and
//       memcpyAtCPUStateOffset.
void fixHelpers(VariableManager &Variables, Module &Module) {
