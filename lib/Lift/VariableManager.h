...
public:
  ...
  getByEnvOffset(intptr_t Offset, std::string Name = "") {
    return getByCPUStateOffsetWithRemainder(LibTcgEnvOffset + Offset, Name);
  }
  ...
  void memOpAtEnvOffset(llvm::IRBuilder<> &Builder,
                        llvm::CallInst *Call,
                        unsigned Offset,
                        bool EnvIsSrc);

  void memOpAtCPUStateOffset(llvm::IRBuilder<> &Builder,
                             llvm::CallInst *Call,
                             unsigned Offset,
                             bool EnvIsSrc) {
  ...
  llvm::StructType *getCPUStateType() const { return ArchCPUStruct; }
...
public:
  ...
  std::pair<llvm::GlobalVariable *, unsigned>
  getByCPUStateOffsetWithRemainder(intptr_t Offset, std::string Name = "");
