...
class ReachingDefinitionsPass : public llvm::FunctionPass {
public:
...
public:
  ...
  ReachingDefinitionsPass() : llvm::FunctionPass(ID){};
  ReachingDefinitionsPass(char &ID) : llvm::FunctionPass(ID){};
...
class ConditionalReachedLoadsPass : public llvm::FunctionPass {
public:
  using ReachingDefinitionsVector = llvm::SmallVector<llvm::Instruction *, 4>;
...
public:
  ...
  ConditionalReachedLoadsPass() : llvm::FunctionPass(ID){};
