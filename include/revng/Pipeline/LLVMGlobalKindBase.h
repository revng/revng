...
/// Kind that must be extended to be able to specify how a to deduce
/// the target associated to a particular llvm global object.
///
/// When extented two function must be provided, symbolToTarget must return
/// the target associated to a function if there is any
///
...
public:
  ...
  LLVMGlobalKindBase(llvm::StringRef Name, class Granularity *Gran) :
  ...
  LLVMGlobalKindBase(llvm::StringRef Name,
                     Kind &Parent,
