...
extern pipeline::Granularity FunctionsGranularity;
...
public:
  TaggedFunctionKind(llvm::StringRef Name, const FunctionTags::Tag &Tag) :
    pipeline::LLVMKind(Name, &FunctionsGranularity), Tag(&Tag) {}

  TaggedFunctionKind(llvm::StringRef Name,
                     TaggedFunctionKind &Parent,
                     const FunctionTags::Tag &Tag) :
    pipeline::LLVMKind(Name, Parent, &FunctionsGranularity), Tag(&Tag) {}
