...
inline constexpr llvm::StringRef getDescription(model::CommonABI::Values V) {
  ...
  case model::CommonABI::Microsoft_x86_stdcall:
    return "32-bit Microsoft x86 abi, it is a modification of "
           ...
           "of the caller";
  case model::CommonABI::Microsoft_x86_fastcall:
  ...
  case model::CommonABI::AAPCS:
    return "32-bit ARM abi";

  case model::CommonABI::SystemV_MIPS_o32:
    return "The \"old\" 32-bit MIPS abi";

  case model::CommonABI::SystemZ_s390x:
    return "The s390x SystemZ ABI";

  case model::CommonABI::Count:
  case model::CommonABI::Invalid:
  default:
    return "Unknown and/or unsupported common abi";
  }
}

} // namespace model::CommonABI

#include "revng/Model/Generated/Late/CommonABI.h"
