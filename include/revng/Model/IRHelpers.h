...
/// return the edge on the model that represents that call, or a null pointer if
/// this doesn't exist
...
/// \brief Return the prototype associated to direct or indirect \a Call.
...
/// functions is not an isolated function, a null pointer is returned.
inline model::Type *
