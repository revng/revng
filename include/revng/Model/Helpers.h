...
inline std::string
customName(const model::StructType &Struct, const model::StructField &Field) {
  return customName(Struct, Field.key());
}

inline std::string
customName(const model::UnionType &Union, const model::UnionField::Key Field) {
  return detail::pathImpl<model::Binary>(Union, "Fields", Field, "CustomName");
}
inline std::string
customName(const model::UnionType &Union, const model::UnionField &Field) {
  return customName(Union, Field.key());
}

inline std::string
customName(const model::EnumType &Enum, const model::EnumEntry::Key &Entry) {
  return detail::pathImpl<model::Binary>(Enum, "Entries", Entry, "CustomName");
}
inline std::string
customName(const model::EnumType &Enum, const model::EnumEntry &Entry) {
...
inline std::string
comment(const model::StructType &Struct, const model::StructField::Key Field) {
  return detail::pathImpl<model::Binary>(Struct, "Fields", Field, "Comment");
}
inline std::string
comment(const model::StructType &Struct, const model::StructField &Field) {
  return comment(Struct, Field.key());
}

inline std::string
comment(const model::UnionType &Union, const model::UnionField::Key Field) {
  return detail::pathImpl<model::Binary>(Union, "Fields", Field, "Comment");
}
inline std::string
comment(const model::UnionType &Union, const model::UnionField &Field) {
  return comment(Union, Field.key());
}

inline std::string
comment(const model::EnumType &Enum, const model::EnumEntry::Key &Entry) {
  return detail::pathImpl<model::Binary>(Enum, "Entries", Entry, "Comment");
}
inline std::string
comment(const model::EnumType &Enum, const model::EnumEntry &Entry) {
