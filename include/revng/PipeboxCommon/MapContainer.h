...
using MC = MapContainer<K, S>;

} // namespace detail

using BytesContainer = detail::MC<Kinds::Binary, "BytesContainer">;

using FunctionToBytesContainer = detail::MC<Kinds::Function,
                                            "FunctionToBytesContaine"
                                            "r">;

using TypeDefinitionToBytesContainer = detail::MC<Kinds::TypeDefinition,
