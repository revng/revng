...
# TODO: we should return the fields in a stable order in `all_fields`
...
class StructField(ABC):
    ...
    def from_yaml(source_dict: Dict):
        ...
        if source_dict.get("reference-to"):
            args = copy.copy(source_dict)
            args["pointee_type"] = source_dict["reference-to"]
            del args["reference-to"]
